...
\begin{DoxyCompactList}\small\item\em \-The transmit function is used to communicate with \-Lab\-View? through a series of preset strings, which are represented by the graphical gauages? \end{DoxyCompactList}\item 
...
\-The transmit function is used to communicate with \-Lab\-View? through a series of preset strings, which are represented by the graphical gauages? 
