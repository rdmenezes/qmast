...
points waypoints[10] ={        //optional preset values for registers
  {44.0, 22.8512, -76.0, -49.1558}, 
  {44.0, 22.8572, -76.0, -49.1532}, //middle tree
...
points boatLocation = {44.0, 22.8532, -76.0, -49.1678};        // boats current location, 
...
//GPGLL,4413.6803,N,07629.5175,W,232409,A,A*58 south lamp post
 ...
 //these values need to be converted by dividing the minute by 0.6
