...
double GPSconv(double lat1, double long1, double lat2, double long2)   //looks like its no longer used -laz
...
//the time between each adjustment will include checking the menu but it should still be fast enough. Needs to be tested and compared to existing sailcourse function.
void sailCourse2(){
  //sail the race course   
  int error; 
  int distanceToWaypoint;//the boat's distance to the present waypoint
